...
{:then data}
	{#if office == 'LAUDS'}
		...
		{:else}
			<p>
				<a href="https://www.biblegateway.com/passage/?search={data.morning}&version=NRSVUE">
					{data.morning}
				</a>
			</p>
		{/if}
	{:else}
		...
		{:else}
			<p>
				<a href="https://www.biblegateway.com/passage/?search={data.evening}&version=NRSVUE">
					{data.evening}
				</a>
			</p>
		{/if}
