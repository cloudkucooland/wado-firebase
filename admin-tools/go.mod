module indievisible.org/wado/v2

go 1.22.7

replace github.com/cloudkucooland/go-oramus => /home/scot/old-projects/go-oremus

require (
	cloud.google.com/go/firestore v1.17.0
	cloud.google.com/go/secretmanager v1.14.1
	firebase.google.com/go/v4 v4.14.1
	github.com/cloudkucooland/go-oremus v0.0.0-20241002024023-dad470265065
